...
void main() {
  ...
  void setUpMockHttpClientSuccess200(
      String urlExpected, Map<String, dynamic> json) {
    ...
    test(
      ...
      () async {
        ...
        setUpMockHttpClientSuccess200(
            urlMovieTrending, jsonReader('movie_result.json'));
        // act
  ...
  group('getNowPlayingMOvies', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieNowPlaying, jsonReader('movie_result.json'));
        // act
  ...
  group('getPopularMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMoviePopular, jsonReader('movie_result.json'));
        // act
  ...
  group('getTopRatedMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieTopRated, jsonReader('movie_result.json'));
        // act
  ...
  group('getUpcomingMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieUpcoming, jsonReader('movie_result.json'));
        // act
  ...
  group('getMoviesByGenre', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieByGenre, jsonReader('movie_result.json'));
        // act
  ...
  group('getMovieDetail', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieDetail, jsonReader('movie_detail.json'));
        // act
  ...
  group('getCastCrew', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieCastCrew, jsonReader('movie_cast_crew.json'));
        // act
  ...
  group('getVideos', () {
    ...
    test(
      ...
      () async {
        // arrange
        setUpMockHttpClientSuccess200(
            urlMovieVideos, jsonReader('movie_video.json'));
        // act
  ...
  group('getSearchedMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(() => client
                .get(urlSearchedMovies, queryParameters: {'query': searchText}))
