...
import 'package:movie_app/data/models/movie_results_model.dart';
...
class MockMovieRemoteDatasource extends Mock
    implements IMovieRemoteDataSource {}
...
void main() {
  ...
  test(
    ...
    () async {
      const getCastCrewList = CastCrewResultModel(id: 2, cast: [], crew: []);
      // arrange
  ...
  test(
    ...
    () async {
      final videoResultModel = VideoResultModel(id: 2, videos: const []);
      // arrange
