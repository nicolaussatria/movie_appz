...
import 'package:movie_app/domain/usecases/get_popular_movie_by_genre_usecase.dart';
...
class MockGetTopRatMoviesUsecase extends Mock
    implements GetTopRatMoviesUsecase {}
...
class MockGetMovieByGenreUsecase extends Mock
    implements GetMovieByGenreUsecase {}
...
void main() {
  ...
  group('moviesBloc (Success)', () {
    ...
    blocTest<MoviesBloc, MoviesState>(
      ...
      setUp: () {
        when(() => mockGetUpcomingMoviesUsecase(1))
            .thenAnswer((_) async => const Right(<MovieEntity>[]));
      },
      build: () => moviesBloc,
    ...
    blocTest<MoviesBloc, MoviesState>(
      ...
      setUp: () {
        when(() => mockGetTopRatMoviesUsecase(1))
            .thenAnswer((_) async => const Right(<MovieEntity>[]));
      },
      build: () => moviesBloc,
    ...
    blocTest<MoviesBloc, MoviesState>(
      ...
      setUp: () {
        when(() => mockGetPopularMoviesUsecase(1))
            .thenAnswer((_) async => const Right(<MovieEntity>[]));
      },
      build: () => moviesBloc,
    ...
    blocTest<MoviesBloc, MoviesState>(
      ...
      setUp: () {
        when(() => mockGetNowPlayingMoviesUsecase(1))
            .thenAnswer((_) async => const Right(<MovieEntity>[]));
      },
      build: () => moviesBloc,
    ...
    blocTest<MoviesBloc, MoviesState>(
      ...
      setUp: () {
        when(() => mockGetMovieByGenreUsecase(1))
            .thenAnswer((_) async => const Right(<MovieEntity>[]));
      },
      build: () => moviesBloc,
