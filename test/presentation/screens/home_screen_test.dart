...
import 'package:movie_app/presentation/widgets/genres_and_popular_movies.dart';
import 'package:movie_app/presentation/widgets/now_playing_movies_listview.dart';
import 'package:movie_app/presentation/widgets/search_bar/search_bar.dart';
import 'package:movie_app/presentation/widgets/tabs/tabbar_movies.dart';
...
void main() {
  ...
  testWidgets('home screen test', (tester) async {
    ...
    expect(find.byType(SearchBarz), findsOneWidget);
